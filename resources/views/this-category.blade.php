...
<div class="body-c" id="body-c">
  <div class="row container-fluid this-cat-header">
    <div class="proj-header col-sm-6 col-xs-6">
      <h6>{{__('messages.recent_projects')}}</h6>
    </div>
    <div class="proj-numb col-sm-6 col-xs-6">
    ...
    <div class="row container-fluid flex-container" >
      @foreach($projects as $p)
         <div class="col-md-6 sos-img ">
            <div id="spinner"></div>
            <a href="{{ url("projects/{$catSlug}/{$p->slug}")}}">
            ...
            <div class="img-cap">
              <h6 class = "seo-h6">{{$p->getTranslatedAttribute('location',  app()->getLocale(), 'fallbackLocale')}}</h6>
